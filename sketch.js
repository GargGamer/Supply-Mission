...
function setup() {
	...
	box1.shapeColor = "red"
	boxbody1 = Bodies.rectangle(width/2 , 200 ,width, 5 , {restitution:0, isStatic:true});
	World.add(world, boxbody1)
	box2 = createSprite(400,660,100,20)
	box2.shapeColor = "red"
	boxbody2 = Bodies.rectangle(width/2 , 200 ,width, 5 , {restitution:0, isStatic:true});
	World.add(world, boxbody2)
	box3 = createSprite(460,630,20,80)
	box3.shapeColor = "red"
	boxbody3 = Bodies.rectangle(width/2 , 200 ,width, 5 , {restitution:0, isStatic:true});
